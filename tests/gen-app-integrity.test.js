...
suite('gen: sw.js cache manifest', () => {
    test('ASSETS array literal parses with exactly 89 entries', () => {
...
suite('gen: sw.js js/css assets exist on disk', () => {
    test('ASSETS contains 58 /js/*.js, 1 /css/*.css, 27 /img/* entries', () => {
        assert.equal(JS_ASSETS.length, 58, 'js asset count changed');
...
suite('gen: index.html script tags', () => {
    test('index.html has exactly 57 <script src> tags, all under js/', () => {
        assert.equal(SCRIPT_SRCS.length, 57,
