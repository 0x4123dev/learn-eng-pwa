...
const FEATURES = [
  ...
  { id: 'ptnk-practice', name: 'PTNK — luyện dạng đề: đọc hiểu, điền từ, tìm lỗi sai, ngữ pháp & từ vựng',
    screens: ['readingScreen', 'clozeScreen', 'errorsScreen', 'grammarVocabScreen'],
    banks: ['js/reading-data.js', 'js/cloze-data.js', 'js/errors-data.js', 'js/grammar-vocab-data.js'], verifiedBy: 'client' },
