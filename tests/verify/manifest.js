...
const FEATURES = [
  ...
  { id: 'ptnk-practice', name: 'PTNK — luyện dạng đề: đọc hiểu, điền từ, tìm lỗi sai',
    screens: ['readingScreen', 'clozeScreen', 'errorsScreen'],
    banks: ['js/reading-data.js', 'js/cloze-data.js', 'js/errors-data.js'], verifiedBy: 'client' },
