...
// The card is built from raidSnapshot, not homeSnapshot, for the same reason:
// the defender's crops and their private extra farm boards are their state
// too, and the preview is only ever about what the troops will run into.
