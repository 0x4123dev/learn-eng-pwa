...
export async function onRequestPost({request,env}) {
  ...
  // rules' ceiling (resolveAutoBattle caps damage at 100000, so damage>defense
  // can never hold) and finish.js charges the raider the flat shield loss.
  ...
  if(shielded){target.shielded=true;target.defense=100000;target.castleHp=5000;}
