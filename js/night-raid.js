...
var NightRaid = (() => {
  ...
  // Bot combat is a QA aid for accounts explicitly enabled by an admin. A
  // normal child must never see it mixed into the real-house picker.
  function botTrialButton(){return appState.allowBot?'<button class="nr-secondary nr-wide nr-bot-trial" type="button" onclick="nrScoutBot()">Chơi thử với Bot</button>':'';}
