...
const MATH_SOURCE_EXAMS = [
  {
    ...
    questions: [
      ...
      _srcMcq('s1-12', 12, 5, 'I. Trắc nghiệm - Câu 12', 'Câu 12. Biểu đồ hình quạt tròn thống kê tỉ lệ điểm kiểm tra cuối học kì I khối 7. Biết không có học sinh dưới 5,0. Số học sinh đạt điểm từ 9,0 đến 10,0 chiếm tỉ lệ là',
        ...
        _srcCrop('/assets/math-exams/hk1-1-page2.jpg', [1075, 1521], [534, 240, 436, 262], 'Biểu đồ quạt tròn nguyên bản của Câu 12'),
        'Các phần cộng lại cho kết quả 9%, nhưng đề gốc thiếu lựa chọn 9%. Trong hình, màu các ô chú giải cũng không khớp với màu các hình quạt — hãy đọc theo số phần trăm ghi trên từng hình quạt, đừng dò theo màu.'),
      ...
      _srcWritten('s1-15', 15, 3, 'II. Tự luận - Bài 3 (0,5 điểm)', 'Bài 3 (0,5 điểm). Hình vẽ cho biết xx′ // yy′ và ∠ABy′ = 55°. Tính ∠xAB.',
        ...
        _srcCrop('/assets/math-exams/hk1-1-page2.jpg', [1075, 1521], [566, 793, 300, 178], 'Hình hai đường thẳng song song của Bài 3')),
      _srcWritten('s1-16', 16, 5, 'II. Tự luận - Bài 4 (0,75 điểm)', 'Bài 4 (0,75 điểm). Biểu đồ thể hiện thời gian giải một bài toán của học sinh lớp 7/4. Lập bảng thống kê. Nếu giải trong 5 phút thì nhận thưởng, lớp có bao nhiêu bạn được nhận thưởng?',
        ...
        _srcCrop('/assets/math-exams/hk1-1-page2.jpg', [1075, 1521], [60, 1022, 620, 318], 'Biểu đồ đoạn thẳng nguyên bản của Bài 4')),
...

  {
    ...
    questions: [
      ...
      _srcMcq('s2-5', 5, 6, 'I. Trắc nghiệm - Câu 5', 'Câu 5. Mặt đáy của hình lăng trụ đứng ở hình bên là:', ['EAD và FBC', 'ABCD và ABFE', 'ABFE', 'ABCD'], 0, 'EAD và FBC', '🔑 Hai mặt đáy song song và bằng nhau là hai tam giác EAD và FBC.', _srcCrop('/assets/math-exams/hk1-2-page1.jpg', [1105, 1430], [700, 645, 360, 205], 'Hình lăng trụ đứng của Câu 5')),
      ...
      _srcMcq('s2-7', 7, 3, 'I. Trắc nghiệm - Câu 7', 'Câu 7. Quan sát hình vẽ, ∠P₂ và ∠Q₂ là:', ['Hai góc kề bù', 'Hai góc đối đỉnh', 'Hai góc đồng vị', 'Hai góc so le trong'], 3, 'Hai góc so le trong', '🔑 Hai góc nằm giữa hai đường thẳng và ở hai phía của đường cắt.', _srcCrop('/assets/math-exams/hk1-2-page1.jpg', [1105, 1430], [700, 915, 370, 195], 'Hình các cặp góc của Câu 7')),
      _srcMcq('s2-8', 8, 3, 'I. Trắc nghiệm - Câu 8', 'Câu 8. Hình vẽ nào sau đây có hai đường thẳng song song?', ['Hình 1', 'Hình 2', 'Hình 3', 'Hình 4'], 1, 'Hình 2', '🔑 Ở Hình 2 có một cặp góc so le trong bằng nhau 65°, nên hai đường thẳng song song.', _srcCrop('/assets/math-exams/hk1-2-page1.jpg', [1105, 1430], [55, 1105, 1010, 200], 'Bốn hình lựa chọn của Câu 8')),
...

  {
    ...
    questions: [
      ...
      _srcMcq('s3-12',12,3,'I. Trắc nghiệm - Câu 12','Câu 12. Tìm số đo x trong hình vẽ, biết a // b:',['x = 30°','x = 120°','x = 60°','x = 180°'],2,'x = 60°','🔑 Hai góc so le trong bằng nhau nên x = 60°.',_srcCrop('/assets/math-exams/hk1-3-page2.jpg',[1075,1521],[590,430,400,260],'Hình đầy đủ hai đường thẳng song song và góc 60° của Câu 12')),
...

  {
    ...
    questions: [
      ...
      _srcMcq('s4-6',6,6,'I. Trắc nghiệm - Câu 6','Câu 6. Các cạnh bên của hình hộp chữ nhật ABCD.A′B′C′D′ là:',['AA′, BB′, CC′, DD′','AB, AA′, DD′, BC′','AC, BA, CC′, AD','A′C′, B′D′, AB, CD'],0,'AA′, BB′, CC′, DD′','🔑 Bốn cạnh nối hai đáy tương ứng là AA′, BB′, CC′, DD′.',_srcCrop('/assets/math-exams/hk1-4-page1.jpg',[1075,1521],[752,872,176,190],'Hình hộp chữ nhật của Câu 6')),
      ...
      _srcMcq('s4-8',8,3,'I. Trắc nghiệm - Câu 8','Câu 8. Quan sát hình vẽ. Góc kề bù với góc aOb là:',['∠bOc','∠bOd','∠dOc','∠aOc'],1,'∠bOd','🔑 Oa và Od là hai tia đối nhau, nên ∠aOb và ∠bOd kề bù.',_srcCrop('/assets/math-exams/hk1-4-page1.jpg',[1075,1521],[385,1168,358,170],'Hình góc aOb của Câu 8')),
      ...
      _srcWritten('s4-16',16,6,'II. Tự luận - Câu 16 (0,5 điểm)','Câu 16 (0,5 điểm). Khối bê tông là lăng trụ đứng tam giác có kích thước như hình. Tính thể tích.','1848 m³.','🔑 V = (1/2·7·24)·22 = <b>1848 m³</b>.',_srcCrop('/assets/math-exams/hk1-4-page3.jpg',[1075,1521],[512,100,405,190],'Hình khối bê tông của Câu 16')),
      _srcWritten('s4-17',17,3,'II. Tự luận - Câu 17 (0,5 điểm)','Câu 17 (0,5 điểm). Cho hình vẽ, biết a // b và ∠B₁ = 130°. Tính ∠A₁ và ∠A₂.','∠A₁ = 130°, ∠A₂ = 50°.','🔑 Vì a // b nên ∠A₁ = ∠B₁ = <b>130°</b> (hai góc đồng vị).<br>🔑 ∠A₁ và ∠A₂ kề bù nên ∠A₂ = 180° − 130° = <b>50°</b>.',_srcCrop('/assets/math-exams/hk1-4-page3.jpg',[1075,1521],[475,300,500,275],'Hình hai đường thẳng song song của Câu 17')),
      _srcWritten('s4-18',18,3,'II. Tự luận - Câu 18 (1 điểm)','Câu 18 (1 điểm). a) Cho định lí: Nếu c cắt a, b và có một cặp góc so le trong bằng nhau thì a, b song song. Vẽ hình, viết giả thiết và kết luận bằng kí hiệu. b) Cho △ABC có ∠C = 35°, ∠A = 65°. Tính ∠B.','a) GT: c cắt a,b; một cặp góc so le trong bằng nhau. KL: a // b. b) ∠B = 80°.','🔑 a) Viết đúng GT và KL như trên.<br>🔑 b) ∠B = 180° − 65° − 35° = <b>80°</b>.',_srcCrop('/assets/math-exams/hk1-4-page3.jpg',[1075,1521],[200,748,292,250],'Hình tam giác của Câu 18b')),
...

  {
    ...
    questions: [
      ...
      _srcMcq('s5-6',6,6,'I. Trắc nghiệm - Câu 6','Câu 6. Hình nào sau đây là hình hộp chữ nhật?',['Hình 1','Hình 2','Hình 3','Hình 4'],3,'Hình 4','🔑 Hình 4 là hình hộp chữ nhật.',_srcCrop('/assets/math-exams/hk1-5-page1.jpg',[1105,1430],[215,802,760,106],'Bốn hình đồ vật của Câu 6')),
      _srcMcq('s5-7',7,3,'I. Trắc nghiệm - Câu 7','Câu 7. Hình nào dưới đây có cặp góc đối đỉnh?',['Hình a','Hình b','Hình c','Hình d'],2,'Hình c','🔑 Hình c có hai đường thẳng cắt nhau, tạo cặp góc đối đỉnh.',_srcCrop('/assets/math-exams/hk1-5-page1.jpg',[1105,1430],[185,987,775,140],'Bốn hình góc của Câu 7')),
      _srcMcq('s5-8',8,5,'I. Trắc nghiệm - Câu 8','Câu 8. Điểm kiểm tra học kì I môn Toán của 5 bạn Minh, Mai, Hưng, Lan, Nhung được ghi lại trong bảng. Kết quả của ai bị ghi nhầm?',['Minh','Lan','Hưng','Nhung'],1,'Lan','🔑 Điểm kiểm tra theo thang 10 nên 10,5 là không hợp lệ; đó là điểm của Lan.',_srcCrop('/assets/math-exams/hk1-5-page1.jpg',[1105,1430],[90,1245,930,90],'Bảng điểm kiểm tra học kì I của năm học sinh ở Câu 8')),
      ...
      _srcWritten('s5-13',13,6,'II. Tự luận - Câu 5 (1 điểm)','Câu 5 (1 điểm). Thùng thép không nắp dạng lăng trụ đứng tam giác, dài 75 cm; tam giác đáy có ba cạnh 60 cm, 80 cm, 100 cm. a) Tính thể tích. b) Tính diện tích thép cần dùng theo m².','a) 180 000 cm³. b) 1,53 m².','🔑 Tam giác 60-80-100 vuông, diện tích đáy = 60·80/2=2400 cm².<br>🔑 a) V=2400·75=<b>180 000 cm³</b>.<br>🔑 b) Diện tích kín là 2·2400+(60+80+100)·75=22800 cm². Mặt hở (theo hình) là mặt nghiêng 100 cm × 75 cm = 7500 cm², nên diện tích thép là 22800 − 7500 = 15300 cm² = <b>1,53 m²</b>.',_srcCrop('/assets/math-exams/hk1-5-page2.jpg',[1105,1430],[492,806,285,210],'Hình lăng trụ tam giác của thùng thép, đủ bốn kích thước ở Câu 5')),
      _srcWritten('s5-14',14,3,'II. Tự luận - Câu 6 (2 điểm)','Câu 6 (2 điểm). Cho hình vẽ biết ∠G₁ = 80°, ∠F₁ = 80°, ∠B₁ = 60°. a) Chứng minh m // n. b) Tính ∠D₁, ∠D₃. c) Dx là tia phân giác của ∠BDH, cắt m tại E. Tính ∠BED.','a) m // n. b) ∠D₁ = 60°, ∠D₃ = 120°. c) ∠BED = 60°.','🔑 a) ∠G₁ = ∠F₁ = 80° là hai góc đồng vị nên <b>m // n</b>.<br>🔑 b) ∠D₁ và ∠B₁ là hai góc đồng vị (cùng ở phía trên đường thẳng của mình và cùng bên trái cát tuyến BD) nên ∠D₁ = ∠B₁ = <b>60°</b>.<br>🔑 Góc 3 nằm phía dưới n, cùng bên trái cát tuyến, nên ∠D₃ KỀ BÙ với ∠D₁: ∠D₃ = 180° − 60° = <b>120°</b>. (Góc đối đỉnh với ∠D₁ là ∠D₂, đề không hỏi.)<br>🔑 c) ∠BDH = 180° − ∠D₁ = 120°; Dx là tia phân giác nên ∠BDE = 60°. Lại có ∠DBE = ∠B₁ = 60° (đối đỉnh), nên trong △BDE: <b>∠BED = 180° − 60° − 60° = 60°</b>.',_srcCrop('/assets/math-exams/hk1-5-page2.jpg',[1105,1430],[525,1035,460,300],'Hình đường thẳng của Câu 6'))
    ]
  }
];
