...
> This file provides context and instructions for Codex CLI when working on this project.
...
│   └── settings.local.json    # Codex settings
├── AGENTS.md                  # This file
...
See `.Codex/agents/_collaboration.md` for:
...
See `.Codex/agents/_error-recovery.md` for:
...
- **.Codex/CONTRIBUTING.md** - How to modify/add agents

### Agent System
- **.Codex/agents/_collaboration.md** - Agent dependencies
- **.Codex/agents/_error-recovery.md** - Error handling patterns
- **.Codex/agents/_metrics.md** - Usage tracking guidelines
- **.Codex/CHANGELOG.md** - System version history
- **.Codex/VERSION** - Current system version
